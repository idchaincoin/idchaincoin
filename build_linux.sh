...
# Create zip file of binaries
	cp idchaincoin/src/idchaincoind idchaincoin/src/idchaincoin-cli idchaincoin/src/idchaincoin-tx idchaincoin/src/qt/idchaincoin-qt .
	zip DCT-$(git describe --abbrev=0 --tags | sed s/v//)-Linux.zip idchaincoind idchaincoin-cli idchaincoin-tx idchaincoin-qt
	rm -f idchaincoind idchaincoin-cli idchaincoin-tx idchaincoin-qt
