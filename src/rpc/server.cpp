...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DCT features */
        {"idchaincoin", "listmasternodes", &listmasternodes, true },
        {"idchaincoin", "getmasternodecount", &getmasternodecount, true },
        {"idchaincoin", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"idchaincoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"idchaincoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"idchaincoin", "masternodecurrent", &masternodecurrent, true },
        {"idchaincoin", "startmasternode", &startmasternode, true },
        {"idchaincoin", "createmasternodekey", &createmasternodekey, true },
        {"idchaincoin", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"idchaincoin", "listmasternodeconf", &listmasternodeconf, true },
        {"idchaincoin", "getmasternodestatus", &getmasternodestatus, true },
        {"idchaincoin", "getmasternodewinners", &getmasternodewinners, true },
        {"idchaincoin", "getmasternodescores", &getmasternodescores, true },
        {"idchaincoin", "preparebudget", &preparebudget, true },
        {"idchaincoin", "submitbudget", &submitbudget, true },
        {"idchaincoin", "mnbudgetvote", &mnbudgetvote, true },
        {"idchaincoin", "getbudgetvotes", &getbudgetvotes, true },
        {"idchaincoin", "getnextsuperblock", &getnextsuperblock, true },
        {"idchaincoin", "getbudgetprojection", &getbudgetprojection, true },
        {"idchaincoin", "getbudgetinfo", &getbudgetinfo, true },
        {"idchaincoin", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"idchaincoin", "mnfinalbudget", &mnfinalbudget, true },
        {"idchaincoin", "checkbudgets", &checkbudgets, true },
        {"idchaincoin", "mnsync", &mnsync, true },
        {"idchaincoin", "spork", &spork, true },
...
{
    return "> idchaincoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:29094/\n";
}
