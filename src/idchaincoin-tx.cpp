...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("DCT idchaincoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  idchaincoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded idchaincoin transaction") + "\n" +
                               "  idchaincoin-tx [options] -create [commands]   " + _("Create hex-encoded idchaincoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded idchaincoin transaction
