...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            DCTGUI* window = static_cast<DCTGUI*>(parentWidget());
...
{
    DCTGUI* gui = static_cast<DCTGUI*>(parentWidget());
...
{
    hide();
    static_cast<DCTGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("DCT will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your DCTs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
