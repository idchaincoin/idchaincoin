...
#include "qt/idchaincoin/furabstractlistitemdelegate.h"
#include "qt/idchaincoin/furlistrow.h"
#include "transactiontablemodel.h"
#include "qt/idchaincoin/txviewholder.h"
...
#include "config/idchaincoin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    explicit DashboardWidget(DCTGUI* _window);
    ~DashboardWidget();
