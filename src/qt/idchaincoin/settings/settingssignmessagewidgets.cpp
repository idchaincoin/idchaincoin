...
#include "qt/idchaincoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(DCTGUI* _window, QWidget *parent) :
