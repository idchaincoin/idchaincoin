...
#include "qt/idchaincoin/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(DCTGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &DCTGUI::openFAQ);
