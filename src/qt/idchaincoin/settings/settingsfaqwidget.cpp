...
#include "qt/idchaincoin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/idchaincoin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(DCTGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableDCT,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableDCT,
    ...
    connect(ui->pushButton_UnspendableDCT, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableDCT);});
    ...
    if (parent)
        connect(parent, &DCTGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
