...
#include "qt/idchaincoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(DCTGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("DCT_tx_csv_export(*.csv)") : tr("DCT_addresses_csv_export(*.csv)"),
                                        nullptr);
