...
#include "qt/idchaincoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/idchaincoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(DCTGUI* _window, QWidget *parent) :
