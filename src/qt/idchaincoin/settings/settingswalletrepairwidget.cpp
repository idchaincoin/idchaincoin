...
#include "qt/idchaincoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/idchaincoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(DCTGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to DCTGUI::handleRestart()
