...
#include "qt/idchaincoin/settings/settingsnetworkwidget.h"
#include "qt/idchaincoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/idchaincoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(DCTGUI* _window, QWidget *parent) :
