...
#include "qt/idchaincoin/forms/ui_send.h"
#include "qt/idchaincoin/addnewcontactdialog.h"
#include "qt/idchaincoin/qtutils.h"
#include "qt/idchaincoin/sendchangeaddressdialog.h"
#include "qt/idchaincoin/optionbutton.h"
#include "qt/idchaincoin/sendconfirmdialog.h"
#include "qt/idchaincoin/myaddressrow.h"
#include "qt/idchaincoin/guitransactionsutils.h"
...
SendWidget::SendWidget(DCTGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    ...
    btnContacts(new QPushButton())
{
    ...
    setCssProperty(coinIcon, "coin-icon-heirs");
...
void SendWidget::onContactMultiClicked()
{
    if (focusedEntry) {
        ...
        CTxDestination heirsAdd = DecodeDestination(address.toStdString());
        if (walletModel->isMine(heirsAdd)) {
        ...
        if (dialog->res) {
            ...
            if (walletModel->updateAddressBookLabels(heirsAdd, dialog->getLabel().toStdString(),
                    AddressBook::AddressBookPurpose::SEND)) {
