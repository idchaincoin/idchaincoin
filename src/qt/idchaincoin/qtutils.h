...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, DCTGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, DCTGUI* gui, double posX = 3);
