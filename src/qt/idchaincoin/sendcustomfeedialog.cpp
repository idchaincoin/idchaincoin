...
#include "qt/idchaincoin/sendcustomfeedialog.h"
#include "qt/idchaincoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(DCTGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &DCTGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
