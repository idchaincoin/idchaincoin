...
/* DCT GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "DCT"
#define QAPP_ORG_DOMAIN "idchaincoin.org"
#define QAPP_APP_NAME_DEFAULT "DCT-Qt"
#define QAPP_APP_NAME_TESTNET "DCT-Qt-testnet"
