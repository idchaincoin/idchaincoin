...
/** Utility functions used by the DCT Qt UI.
 */
namespace GUIUtil
{
...
// Render DCT addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZheirs = false);
...
// Parse "idchaincoin:" URI into recipient object, return true on successful parsing
