...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(DCT);
    unitlist.append(mDCT);
    unitlist.append(uDCT);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    ...
    case mDCT:
        return QString("mDCT");
    case uDCT:
        return QString::fromUtf8("uDCT");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZheirs)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZDCT)
{
    QSettings settings;
...
QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZDCT)
{
