...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/idchaincoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/idchaincoin-cli.cpp \
           src/idchaincoin-tx.cpp \
           src/idchaincoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/idchaincoin.qrc src/qt/idchaincoin_locale.qrc

TRANSLATIONS += src/qt/locale/idchaincoin_bg.ts \
                src/qt/locale/idchaincoin_de.ts \
                src/qt/locale/idchaincoin_en.ts \
                src/qt/locale/idchaincoin_es.ts \
                src/qt/locale/idchaincoin_fi.ts \
                src/qt/locale/idchaincoin_fr.ts \
                src/qt/locale/idchaincoin_it.ts \
                src/qt/locale/idchaincoin_ja.ts \
                src/qt/locale/idchaincoin_pl.ts \
                src/qt/locale/idchaincoin_pt.ts \
                src/qt/locale/idchaincoin_ru.ts \
                src/qt/locale/idchaincoin_sk.ts \
                src/qt/locale/idchaincoin_sv.ts \
                src/qt/locale/idchaincoin_vi.ts \
                src/qt/locale/idchaincoin_zh_CN.ts \
                src/qt/locale/idchaincoin_zh_TW.ts
