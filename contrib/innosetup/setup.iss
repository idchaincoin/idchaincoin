...
#define MyAppName "DCT Core"
#define MyAppPublisher "2023 DCT Core Developers"
#define MyAppURL "https://idchaincoin.net"
#define MyAppExeName "idchaincoin-qt.exe"
#define MyAppExtraData "https://explorer.idchaincoin.net/bootstraps/DCT/bootstrap.zip"
...
[Files]
Source: ".\package\idchaincoin-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\DCT\DCT-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\DCT\DCT-Qt,strDataDir|{userappdata}\DCT\}');
  Result := True;
end;
