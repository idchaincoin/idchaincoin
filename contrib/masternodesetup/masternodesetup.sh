...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='idchaincoin.conf'
CONFIGFOLDER='/root/.idchaincoin'
COIN_DAEMON='idchaincoind'
COIN_CLI='idchaincoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/idchaincoin/DCT/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='idchaincoin'
COIN_PORT=94631
RPC_PORT=7254
