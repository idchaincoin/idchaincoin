Contributing to DCT Core
============================

The DCT Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/idchaincoin-project/idchaincoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the DCT Core project, and is not to be
confused with overall DCT Network Protocol consensus changes.

Whether a pull request is merged into DCT Core rests with the project merge
...
Patches that change DCT consensus rules are considerably more involved than
...
Where a patchset proposes to change the DCT consensus, it must have been
...
The project leader is the release manager for each DCT Core release.
