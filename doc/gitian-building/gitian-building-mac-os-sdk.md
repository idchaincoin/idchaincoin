...
The script [extract-osx-sdk.sh](https://github.com/idchaincoin-project/idchaincoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
idchaincoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/idchaincoin-project/idchaincoin/blob/master/doc/README_osx.md) for troubleshooting tips.
